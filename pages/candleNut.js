...
export default function candleNut() {
  ...
  return (
    <div className="min-h-screen mx-auto">
      ...
      <section className="fixed top-0 z-20 w-full h-auto p-3 px-5 bg-white border-b border-gray-300 dark:border-gray-button2 font-inter md:px-10 dark:bg-gray-comp">
        <Head>
      ...
      <div className="grid grid-cols-1 p-5 pt-24 space-y-3 md:m-5 md:grid-cols-2 font-inter">
