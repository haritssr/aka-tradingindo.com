...
const WrapperReverse = ({ children, imgSrc, imgAlt }) => {
  return (
    <div className='flex flex-col-reverse max-w-5xl gap-10 px-5 mx-auto text-gray-700 mb-14 md:flex-row-reverse lg:px-10'>
