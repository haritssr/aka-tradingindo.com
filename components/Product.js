...
export default function Product(props) {
  return (
    <div className="z-0 w-5/6 h-auto m-5 mx-auto overflow-hidden transition duration-300 transform shadow-md rounded-xl hover:scale-105 hover:shadow-xl">
      <Image className="z-0" src={`${props.image}`} width={1080} height={605} />
      <div className="flex flex-col p-3 -my-2 bg-gradient-to-br from-gray-50 to-gray-200 ">
