      ...
      <div className="p-5">
        ...
        <div className="flex flex-row items-center justify-center mt-5">
          <a
            ...
            href="https://www.instagram.com/adrianiputri"
          >
            <svg
          ...
          >
            <svg
              className="w-5 h-5 m-2 text-gray-900 hover:text-blue-600"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              className="w-5 h-5 m-2 text-gray-900 hover:text-blue-900"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
