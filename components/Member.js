...
export default function Member(props) {
  return (
    <div className="w-3/4 h-auto mx-auto text-center transition duration-200 transform shadow-lg bg-green-1000 bg-opacity-90 rounded-2xl hover:scale-105 hover:shadow-2xl overflow-clip">
      <div className="p-5">
        <div className="p-5">
          <Image
        ...
        <div className="flex flex-row items-center justify-center mt-5 space-x-5">
          ...
          <a target="_blank" rel="noopener noreferrer" href={`${props.ig}`}>
            ...
            {/* <svg
              className="h-7 w-7 text-color-red"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
